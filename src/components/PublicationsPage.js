...
const allPublications = [
  ...
  { 
    ...
    journal_year: 'International Workshop on the Algorithmic Foundations of Robotics (WAFR) 2024 (Best Paper Award Finalist, IEEE RAS TC on Model-based Optimization for Robotics)', 
